...
class WeekviewCalendarBase extends StatefulWidget {
  ...
  @override
  _WeekviewCalendarBaseState createState() => _WeekviewCalendarBaseState();
}

class _WeekviewCalendarBaseState extends State<WeekviewCalendarBase> {
  ...
  @override
  void didUpdateWidget(WeekviewCalendarBase oldWidget) {
