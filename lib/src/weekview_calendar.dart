...
class WeekviewCalendar<T> extends StatefulWidget {
  /// Locale to format `WeekView Calendar` dates with, for example: `'en_US'`.
  ///
  ...
  /// Specifies `WeekView Calendar`'s current format.
  ...
  /// When set to true, `WeekView Calendar` will fill available height.
  final bool shouldFillViewport;

  /// Whether to display week numbers on calendar.
  final bool weekNumbersVisible;

  /// Used for setting the height of `WeekView Calendar`'s rows.
  final double rowHeight;

  /// Used for setting the height of `WeekView Calendar`'s days of week row.
  ...
  /// `WeekView Calendar` will start weeks with provided day.
  ///
  ...
  /// `HitTestBehavior` for every day cell inside `WeekView Calendar`.
  final HitTestBehavior dayHitTestBehavior;

  /// Specifies swipe gestures available to `WeekView Calendar`.
  ...
  /// Style for `WeekView Calendar`'s header.
  final HeaderStyle headerStyle;

  /// Style for days of week displayed between `WeekView Calendar`'s header and content.
  final DaysOfWeekStyle daysOfWeekStyle;

  /// Style for `WeekView Calendar`'s content.
  final CalendarStyle calendarStyle;

  /// Set of custom builders for `WeekView Calendar` to work with.
  ...
  /// Creates a `WeekView Calendar` widget.
  WeekviewCalendar({
    Key? key,
  ...
  @override
  _WeekviewCalendarState<T> createState() => _WeekviewCalendarState<T>();
}

class _WeekviewCalendarState<T> extends State<WeekviewCalendar<T>> {
  ...
  @override
  void didUpdateWidget(WeekviewCalendar<T> oldWidget) {
